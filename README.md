...
- [Debian](https://cdimage.debian.org/debian-cd/current/amd64/iso-dvd/debian-12.7.0-amd64-DVD-1.iso)
- [Debian netinstall](https://cdimage.debian.org/debian-cd/current/amd64/iso-cd/debian-12.7.0-amd64-netinst.iso)
...
- [Linux Mint Cinnamon](https://mirror.gi.co.id/linuxmint-iso/stable/22/linuxmint-22-cinnamon-64bit.iso)
- [Linux Mint XFCE](https://mirror.gi.co.id/linuxmint-iso/stable/22/linuxmint-22-xfce-64bit.iso)
- [Linux Mint Mate](https://mirror.gi.co.id/linuxmint-iso/stable/22/linuxmint-22-mate-64bit.iso)
- [Linux Lite](https://pinguin.dinus.ac.id/iso/lite/isos/7.2/linux-lite-7.2-64bit.iso)
...
- [TUXEDO OS](https://os.tuxedocomputers.com/TUXEDO-OS-4-202410300530.iso)
...
- [Artix Linux XFCE OpenRC](https://iso.artixlinux.org/iso/artix-xfce-openrc-20230814-x86_64.iso)
- [Artix Linux LXQT OpenRC](https://iso.artixlinux.org/iso/artix-lxqt-openrc-20230814-x86_64.iso)
- [Artix Linux KDE Plasma OpenRC](https://iso.artixlinux.org/iso/artix-plasma-openrc-20230814-x86_64.iso)
...
- [openSUSE Leap 15.6](https://download.opensuse.org/distribution/leap/15.6/iso/openSUSE-Leap-15.6-DVD-x86_64-Media.iso)
